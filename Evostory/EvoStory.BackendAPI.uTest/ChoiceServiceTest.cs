...
namespace EvoStory.BackendAPI.uTest
{
    class ChoiceServiceTest
    {
        ...
        public void CreateChoice_ValidCreateChoiceDTO_ChoiceIsAddToRepository()
        {
            ...
            choiceRepositoryMock.Setup(m => m.CreateChoice(It.IsAny<Choice>()))
                .Returns(choice);
            ...
            var sut = new ChoiceService(choiceRepositoryMock.Object, dtoConversionServiceMock.Object);
